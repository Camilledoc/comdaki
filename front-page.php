...
<section class="a-propos">
    ...
    <div class="a-propos__content">
        <div class="vague-conteneur-a-propos">
            <img id="cercle-1" class="cercle" src="<?php echo get_template_directory_uri() . '\assets\images\cercle-orange.webp'; ?>" alt="vallon en pointillé">    
        </div>
        <div class="a-propos__texte">
            <p><strong>Camille Tromp, freelance graphiste et webdesigner</strong></p>
